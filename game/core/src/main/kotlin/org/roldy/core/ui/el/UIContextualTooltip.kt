...
class UIContextualTooltip(
    ...
    // UI components
    private val content: UIContextualTooltipContent =
        UIContextualTooltipContent(this)
    ...
    class Drawables(
        ...
        val pinProgressBackground: Drawable = drawable { _, _, _, _ -> }
    ) {
...
fun <C : UIContext> contextualTooltip(
    drawables: UIContextualTooltip.Drawables,
