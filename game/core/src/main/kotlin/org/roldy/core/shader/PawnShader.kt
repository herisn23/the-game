...
class PawnShader(
    ...
    val u_texture1 by FetchUniform()
    val u_texture2 by FetchUniform()
    val u_texture3 by FetchUniform()
    val u_texture4 by FetchUniform()
    val u_texture5 by FetchUniform()
    val u_texture6 by FetchUniform()
    val u_texture7 by FetchUniform()

    // smoothness

    val u_skinSmoothness by FetchUniform()
    val u_eyesSmoothness by FetchUniform()
    val u_scleraSmoothness by FetchUniform()
    val u_lipsSmoothness by FetchUniform()
    val u_hairSmoothness by FetchUniform()
    val u_scarsSmoothness by FetchUniform()
    val u_metal1Smoothness by FetchUniform()
    val u_metal2Smoothness by FetchUniform()
    val u_metal3Smoothness by FetchUniform()
    val u_leather1Smoothness by FetchUniform()
    val u_leather2Smoothness by FetchUniform()
    val u_leather3Smoothness by FetchUniform()
    val u_gems1Smoothness by FetchUniform()
    val u_gems2Smoothness by FetchUniform()
    val u_gems3Smoothness by FetchUniform()

    // metallic

    val u_metal1Metallic by FetchUniform()
    val u_metal2Metallic by FetchUniform()
    val u_metal3Metallic by FetchUniform()

    // colors
    val u_feathers1Color by FetchUniform()
    val u_feathers2Color by FetchUniform()
    val u_feathers3Color by FetchUniform()
    val u_feathers1ColorIntensity by FetchUniform()
    val u_feathers2ColorIntensity by FetchUniform()
    val u_feathers3ColorIntensity by FetchUniform()

    val u_gems1Color by FetchUniform()
    val u_gems2Color by FetchUniform()
    val u_gems3Color by FetchUniform()
    val u_gems1ColorIntensity by FetchUniform()
    val u_gems2ColorIntensity by FetchUniform()
    val u_gems3ColorIntensity by FetchUniform()

    val u_cloth1Color by FetchUniform()
    val u_cloth2Color by FetchUniform()
    val u_cloth3Color by FetchUniform()
    val u_cloth1ColorIntensity by FetchUniform()
    val u_cloth2ColorIntensity by FetchUniform()
    val u_cloth3ColorIntensity by FetchUniform()

    val u_leather1Color by FetchUniform()
    val u_leather2Color by FetchUniform()
    val u_leather3Color by FetchUniform()
    val u_leather1ColorIntensity by FetchUniform()
    val u_leather2ColorIntensity by FetchUniform()
    val u_leather3ColorIntensity by FetchUniform()

    val u_metal1Color by FetchUniform()
    val u_metal2Color by FetchUniform()
    val u_metal3Color by FetchUniform()
    val u_metal1ColorIntensity by FetchUniform()
    val u_metal2ColorIntensity by FetchUniform()
    val u_metal3ColorIntensity by FetchUniform()
    val u_scarsColor by FetchUniform()
    val u_scarsColorIntensity by FetchUniform()
    val u_lipsColor by FetchUniform()
    val u_lipsColorIntensity by FetchUniform()
    val u_scleraColor by FetchUniform()
    val u_scleraColorIntensity by FetchUniform()
    val u_hairColor by FetchUniform()
    val u_hairColorIntensity by FetchUniform()
    val u_eyesColor by FetchUniform()
    val u_eyesColorIntensity by FetchUniform()
