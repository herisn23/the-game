...
import org.roldy.rendering.pawn.skeleton.slot.PawnArmorSlotData
import org.roldy.rendering.pawn.skeleton.slot.PawnCustomizationSlotData
import org.roldy.rendering.pawn.skeleton.slot.PawnUnderWearSlotData
import org.roldy.rendering.pawn.skeleton.slot.PawnWeaponSlotData
...
class PawnSkeletonData private constructor(
    ...
    val textureAtlas by disposable {
        AtlasLoader.load("$skeletonPath/${orientation.skeletonName}.atlas")
    }
