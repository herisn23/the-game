dependencies {
    ...
    implementation(projects.old.core)
    implementation(projects.old.layer.data)
    implementation(projects.old.layer.gameplay.world)
    implementation(projects.old.layer.rendering.g2d)
    implementation(projects.old.layer.rendering.pawn)
    implementation(projects.old.layer.rendering.equipment)
    ...
    implementation(projects.old.layer.gameplay.scene)
}